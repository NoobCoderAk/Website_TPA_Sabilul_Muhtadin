                ...
                <div class="card-body">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h4 class="fa-table me-1 fw-bold">Tenaga Pengaja</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($daftar_pengajar as $pengajar) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm mt-2 mb-2" data-bs-toggle="modal" data-bs-target="#hapusModal<?= $pengajar->id ?>"><img src="<?= base_url("Assets/Images/template/delete_icon.png"); ?>" style="height:28px; width:24px;" alt=""></button>
                                                    <button type="button" class="btn btn-sm mt-2 mb-2" data-bs-toggle="modal" data-bs-target="#editModal<?= $pengajar->id ?>"><img src="<?= base_url("Assets/Images/template/edit_icon.png"); ?>" style="height:28px; width:24px;" alt=""></button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
